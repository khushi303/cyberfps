...
const Cryptostraps = () => {
    return (
        <div className='bg-black'>
            <Container className='custom-container py-lg-5 py-3'>
                <Row className='py-5 justify-content-center'>
                    <Col data-aos="zoom-in" data-aos-duration="1500" lg={6} className='d-flex align-items-center justify-content-center justify-content-lg-start'>
                        <img src={csimg} alt="csimg" className='w-100 mw-394' />
                    </Col>
                    <Col data-aos="zoom-in" data-aos-duration="1500" lg={6} className='mt-lg-0 mt-4 d-flex flex-column justify-content-center'>
